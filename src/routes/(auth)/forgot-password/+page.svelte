...
<form class="px-4 py-6 m-auto w-full h-full" method="POST" action="?/forgotPassword">
	...
	<div class="shadow-lg p-6">
		<div class="input-group input-group-vertical my-6">
			...
			<input
				...
				id="email"
				name="email"
				class="input input-sm w-full input-accent"
				placeholder="Email address"
				required
			/>
		</div>
		<button class="w-full btn btn-sm btn-success normal-case btn-wide"
